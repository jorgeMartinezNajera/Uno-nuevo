    ...
    if (!$conn) {
        ...
        if(oci_execute($stid)) 
        {
            if ($row = oci_fetch_array($stid, OCI_ASSOC + OCI_RETURN_NULLS)) 
            {
                ...
                $pelicula .= '<ul>';
                $pelicula .= '<li><strong>ID:</strong>' . htmlentities($row['ID_PELICULA']) . '</li>';
                $pelicula .= '<li><strong>Título:</strong>' . htmlentities($row['NOMBRE']) . '</li>';
                $pelicula .= '<li><strong>Resumen:</strong>' . htmlentities($row['RESUMEN']) . '</li>';
                $pelicula .= '<li><strong>Clasificación:</strong>' . htmlentities($row['CLASIFICACION']) . '</li>';
                $pelicula .= '<li><strong>Duración:</strong>' . htmlentities($row['DURACION']) . '</li>';
                $pelicula .= '<li><strong>Género:</strong>' . htmlentities($row['GENERO']) . '</li>';
                $pelicula .= '</ul>';
